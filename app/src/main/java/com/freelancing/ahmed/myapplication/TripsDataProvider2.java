...
import android.graphics.Bitmap;
    ...
    public class TripsDataProvider2 {


        private String title, longD,longD2;
        private Bitmap img_front, img1, img2;

        public TripsDataProvider2(String title, String longD,String longD2, Bitmap img_front, Bitmap img1, Bitmap img2) {
            this.title = title;
